...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # re-order the columns in df
            column_names_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'Transportation Expense','Distance to Work', 'Age', 'Daily Work Load Average', 'Body Mass Index','Education', 'Children', 'Pets','Absenteeism Time in Hours']
            ...
            df = df.drop(['Daily Work Load Average'],axis=1) #'Day of the Week','Distance to Work','Education','Age'
